...
function similarity(s1, s2) {
    ...
    // Optional: You can also prevent going forward
    window.addEventListener('beforeunload', function (e) {
        history.pushState(null, null, document.URL);
        logout(); // Logout before unloading
    });
    ...
    //     // Perform any synchronous logout actions
    //     // ...
    
    //     // Clear sessionStorage
    //     sessionStorage.clear();
    
    //     // Delay the redirection to ensure synchronous actions complete
    //     setTimeout(function () {
...
document.getElementById('logoutButton').addEventListener('click', function () {
    // Stop speech synthesis when the logout button is clicked
    stopSpeech();
    ...
    // Add other logout-related actions here
    // ...
});
